...
namespace Assets.RobustFSM.Mono
{
    public class MonoFSM<T> : MonoBehaviour, IFSM
    {
        ...
        /// <summary>
        /// A reference to the owner of this instance
        /// </summary>
        ...
        public void OnCollisionStart<T1>(T1 collision)
        {
        ...
        {
            //get the component of the created type 
            Owner = gameObject.GetComponent<T>();
        }
        ...
        {
            OnAnimatorExecuteMove();
        }

        private void OnControllerColliderHit(ControllerColliderHit hit)
        {
            OnControllerColliderCollide(hit);
        }
