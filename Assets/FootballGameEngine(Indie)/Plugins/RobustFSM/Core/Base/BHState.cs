...
namespace RobustFSM.Base
{
    ...
    public class BHState : BState, IHState
    {
        ...
        {
            get => _stateName + "\n" + (CurrentState == null ? string.Empty : CurrentState.StateName);
        ...
        {
            get => _fsm.ManualUpdateFrequency;
            set =>_fsm.ManualUpdateFrequency = value;
        }
        ...
        {
            // on animator execute ik
            OnAnimatorExecuteIK(layerIndex);
        }
        ...
        public override void OnAnimatorExecuteIK(int layerIndex)
        {
            ...
            // run the on animator execute
            _fsm.OnAnimatorExecuteIK(layerIndex);
        ...
        public override void OnAnimatorExecuteMove()
        {
            ...
            _fsm.OnAnimatorExecuteMove();
        }

        public override void OnControllerColliderCollide(ControllerColliderHit hit)
        {
            base.OnControllerColliderCollide(hit);

            _fsm.OnControllerColliderCollide(hit);
        }

        public override void OnCollisionStart<T>(T collision)
        {
            base.OnCollisionStart(collision);

            _fsm.OnCollisionStart(collision);
        }
