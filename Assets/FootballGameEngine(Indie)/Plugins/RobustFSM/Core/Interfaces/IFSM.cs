...
namespace RobustFSM.Interfaces
{
    ...
    { 
        ...
        void OnAnimatorExecuteIK(int layerIndex);

        void OnControllerColliderCollide(ControllerColliderHit hit);

        void OnCollisionStart<T>(T collision);
